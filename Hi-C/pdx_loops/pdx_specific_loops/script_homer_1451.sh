...
merge2Dbed.pl ${sample}v35CR.diffloop1.bedpe ${sample}v70CR.diffloop1.bedpe ${sample}v77CR.diffloop1.bedpe ${sample}v147.diffloop1.bedpe -res 10000 -loop -prefix 1451_gain > output_1451_diffloop1.bedpe 2>&1

merge2Dbed.pl ${sample}v35CR.diffloop2.bedpe ${sample}v70CR.diffloop2.bedpe ${sample}v77CR.diffloop2.bedpe ${sample}v147.diffloop2.bedpe -res 10000 -loop -prefix 1451_loss > output_1451_diffloop2.bedpe 2>&1
