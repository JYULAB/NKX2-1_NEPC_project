...
ad_cre <- readPeakFile("../pp/AD_hg38.bed")
ne_cre <- readPeakFile("../pp/NE_hg38.bed")

loops <- LoopsToRanges("../results/NEPC_loop.bedpe", custom_cols = 2)
...
export(granges_atac_in_anchors_ne, paste0("cre_anchor_only/", "NE_cre_at_NE_recurrent.bed"))
...
write_delim(loops_ne_cre, "NE_recurrent_loops_with_NE_cre.bedpe", col_names = FALSE, delim = "\t")
...
export(granges_atac_in_anchors_ad, paste0("cre_anchor_only/", "AD_cre_at_NE_recurrent.bed"))
...
write_delim(loops_ad_cre, "NE_recurrent_loops_with_AD_cre.bedpe", col_names = FALSE, delim = "\t")
